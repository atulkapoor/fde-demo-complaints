...
| evaluation | labelled-metrics | plain-python | Labelled metrics: output_shape == decision |
| governance | audit-only | plain-python | Audit trail: data_residency == may_leave |
| integration | governed-tools | plain-python | Governed tool boundary: external_systems > 1 |
| observability | traced | plain-python | Distributed tracing: always |
