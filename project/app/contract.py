...
# The decision contract: every complaint closes as exactly one of these,
# spelled as the CRM records them.
...
DECISIONS = (MONETARY_RELIEF, NON_MONETARY_RELIEF, EXPLANATION)
