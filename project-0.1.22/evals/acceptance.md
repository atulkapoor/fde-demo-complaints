...
2. **Sample**: fresh items from live data -- never the golden set (the system has seen those 105 in CI). Size to match the golden set or 30, whichever is larger.
...
- `golden.jsonl`: 105 cases, sha256 `04444030265c2610`
- `edge_case.jsonl`: 4 cases, sha256 `bb4c161c3755420b`
- `adversarial.jsonl`: 11 cases, sha256 `b4fed6fc60fee452`
- holdout: 45 cases, sha256 `d4f85aa92d921a33` -- kept with the engagement, never shipped; fde implement --holdout must be given the file with this digest
