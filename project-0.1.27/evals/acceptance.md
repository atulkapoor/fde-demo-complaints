...
2. **Sample**: fresh items from live data -- never the golden set (the system has seen those 96 in CI). Size to match the golden set or 30, whichever is larger.
...
- `golden.jsonl`: 96 cases, sha256 `d42c8a52dd33fa9f`
- `edge_case.jsonl`: 7 cases, sha256 `d13535e7114660de`
- `adversarial.jsonl`: 11 cases, sha256 `392e5f1efaa2d669`
