...
2. **Sample**: fresh items from live data -- never the golden set (the system has seen those 99 in CI). Size to match the golden set or 30, whichever is larger.
...
- `golden.jsonl`: 99 cases, sha256 `9b44010bdc7947bd`
- `edge_case.jsonl`: 4 cases, sha256 `224c936524624a97`
- `adversarial.jsonl`: 11 cases, sha256 `a78ddbd7606adb6f`
- holdout: 46 cases, sha256 `cd8e63951c38081f` -- kept with the engagement, never shipped; fde implement --holdout must be given the file with this digest
